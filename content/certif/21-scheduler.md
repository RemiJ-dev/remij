...
> **Version :** Symfony **8.0** · **Source :** [symfony.com/doc/8.0/scheduler.html](https://symfony.com/doc/8.0/scheduler.html) · **Généré le :** _à compléter lors de la génération_
>
...
Cette page ne comporte pas de section « Learn more » (vérifié sur la source [scheduler.rst](https://github.com/symfony/symfony-docs/blob/8.0/scheduler.rst)) : pas de pages annexes à couvrir pour ce QCM.
